...
<aside id="sidebar-left" class="{{ $sidebarClass or 'sidebar-circle' }}">
    ...
    <ul class="sidebar-menu">
        ...
        <li {!! Request::is('blog','blog/*')? 'class="submenu active"' : 'class="submenu"' !!}>
            ...
            <ul>
                <li {!! Request::is('blog','blog/grid')? 'class="active"' : null !!}><a href="{{url('admin/blog/grid')}}">Grid</a></li>
                <li {!! Request::is('blog','blog/list')? 'class="active"' : null !!}><a href="{{url('admin/blog/list')}}">List</a></li>
                <li {!! Request::is('blog','blog/single')? 'class="active"' : null !!}><a href="{{url('admin/blog/single')}}">Single</a></li>
            </ul>
        </li>
        <!--/ End navigation - blog -->
