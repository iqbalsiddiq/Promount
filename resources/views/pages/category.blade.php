...
<!-- ========================================= FEATURED PRODUCTS : END ========================================= -->
    ...
    <div class="title-nav">
        <?php    
            $products = DB::table('category')->where('id',$idcategory)->skip(0)->take(1)->get();    
            foreach ($products as $product ):     
        ?>
        <h2 class="inverse">{{$product->title}}</h2>
                            ...
                            <div class="product-item">
                                ...
                                <div class="hover-area">
                                    <div class="add-cart-button"> 
                                        <a href="/cart/addCart/{{$product->id}}/1" class="le-button">add to cart</a>
                                    </div>
